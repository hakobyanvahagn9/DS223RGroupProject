...
model_multinomLogit <- multinom(RES ~ BrandCanon + BrandNikon  + BrandSony +
                                  Sensor.SizeAPS.C..23.6x15.6mm + Sensor.SizeAPS.H..27.9x18.6mm +
                                  Sensor.SizeFull.Frame..36x24mm + 
  Camera.TypeDSLR + Camera.TypeMirrorless + Resolution12.megapixel +
    Resolution24.megapixel + Resolution64.megapixel + Price.1.000 + Price.2.000 +
    Price.3.000, data = big_data)
...
model_bayesian <- glm(formula = RES ~ BrandCanon + BrandNikon + BrandSony + Sensor.SizeAPS.C..23.6x15.6mm + Sensor.SizeAPS.H..27.9x18.6mm + Sensor.SizeFull.Frame..36x24mm + 
  Camera.TypeDSLR + Camera.TypeMirrorless + Resolution12.megapixel + Resolution24.megapixel + Resolution64.megapixel + Price.1.000 + Price.2.000 + Price.3.000,
                 data = big_data, family = binomial(link = 'logit'))
